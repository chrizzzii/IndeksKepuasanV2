                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="{{ url('forgetpassword') }}" class="user">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="password" class="form-control form-control-user" id="password_confirmation" name="password_confirmation" placeholder="Confirm New Password" required>
                                            </div>
                                        </div>
                                        <div class="text-center">
