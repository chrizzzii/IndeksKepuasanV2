...
<body>
    ...
    <div class="container-fluid">
        <h1 class="h3 mb-4 text-gray-800">Indeks Alumni</h1>
        <div class="row">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total
                                            Data Alumni Keseluruhan</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $alumniData }}</div>
                                    </div>
                                    <div class="col-auto">
        ...
        <script>
            ...
            const dataValues = JSON.parse(
                '[{{ $alumniU1 }}, {{ $alumniU2 }}, {{ $alumniU3 }}, {{ $alumniU4 }}, {{ $alumniU5 }}, {{ $alumniU6 }}, {{ $alumniU7 }}, {{ $alumniU8 }}, {{ $alumniU9 }}]'
            );
        ...
        <div class="col-xl-12 col-lg-12 mb-4">
            <div class="card shadow" style="height: 680px; width: 100%; overflow: auto;">
                <div class="card-header py-3" style="color: #FFFFFF" ;>
                    <h6 class=" m-0 font-weight-bold text-primary">Distribusi Alumni per Program Studi</h6>
                </div>
                <div class="card-body">
    ...
    <script>
        var prodiLabels = JSON.parse('{!! json_encode(array_keys($jumlahAlumniPerProdi)) !!}');
        var prodiData = JSON.parse('{!! json_encode(array_values($jumlahAlumniPerProdi)) !!}');
