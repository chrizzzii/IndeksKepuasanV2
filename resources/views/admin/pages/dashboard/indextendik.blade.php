...
@section('title', 'Index Tenaga Kependidikan')
...
<body>
    <div class="container-fluid">
        <h1 class="h3 mb-4 text-gray-800">Indeks Tenaga Kependidikan</h1>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total
                                            Data Tenaga Kependidikan Keseluruhan</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $tendikData }}</div>
                                    </div>
                                    <div class="col-auto">
        ...
        <script>
            ...
            const dataValues = JSON.parse(
                '[{{ $tendikU1 }}, {{ $tendikU2 }}, {{ $tendikU3 }}, {{ $tendikU4 }}, {{ $tendikU5 }}, {{ $tendikU6 }}, {{ $tendikU7 }}, {{ $tendikU8 }}, {{ $tendikU9 }}]'
            );
        ...
        <div class="col-xl-12 col-lg-12 mb-4">
            <div class="card shadow" style="height: 680px; width: 100%; overflow: auto;">
                <div class="card-header py-3" style="color: #FFFFFF" ;>
                    ...
                    text-primary">Distribusi Tenaga Kependidikan per Program Studi</h6>
                </div>
                <div class="card-body">
    ...
    <script>
        var prodiLabels = JSON.parse('{!! json_encode(array_keys($jumlahTendikPerProdi)) !!}');
        var prodiData = JSON.parse('{!! json_encode(array_values($jumlahTendikPerProdi)) !!}');
