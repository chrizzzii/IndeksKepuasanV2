...
@section('title', 'Index Pengguna Lulusan')
...
<body>
    <div class="container-fluid">
        <h1 class="h3 mb-4 text-gray-800">Indeks Pengguna Lulusan</h1>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total
                                            Data Pengguna Lulusan Keseluruhan</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $penggunalulusanData }}</div>
                                    </div>
                                    <div class="col-auto">
        ...
        <script>
            ...
            const dataValues = JSON.parse(
                '[{{ $penggunalulusanU1 }}, {{ $penggunalulusanU2 }}, {{ $penggunalulusanU3 }}, {{ $penggunalulusanU4 }}, {{ $penggunalulusanU5 }}, {{ $penggunalulusanU6 }}, {{ $penggunalulusanU7 }}, {{ $penggunalulusanU8 }}, {{ $penggunalulusanU9 }}]'
            );
