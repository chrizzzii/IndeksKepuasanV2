                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            @if($selectedProdi)
                                            {{ $alumniDatafilter + $tendikDatafilter + $orangtuaDatafilter + $mahasiswaDatafilter }}
                                            @else
                                            {{ $mitraData + $alumniData + $tendikData + $orangtuaData + $mahasiswaData + $penggunalulusanData + $totalDosen }}
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card border-left-primary shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Orang Tua / Wali
                                        </div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">@if(!$selectedProdi)
                                            {{ $orangtuaData }}
                        ...
                        <div class="col-md-3 mb-4">
                                        ...
                                        <div class="col-12 mb-5">
                                            ...
                                            <a href="{{ url('dashboard') }}" class="card border-left-primary shadow h-100 py-2">
                                                <div class="card-body">
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col mr-2">
                                                            <div class="text-xs text-center font-weight-bold text-primary text-uppercase mb-1">Kembali ke Indeks Keseluruhan
                                                            </div>
                                                        </div>
                                                        <div class="col-auto">
                                            ...
                                            <a href="{{ url('/pilihprodi') }}" class="card border-left-primary shadow h-100 py-2">
                                                <div class="card-body">
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col mr-2">
                                                            <div class="text-xs text-center font-weight-bold text-primary text-uppercase mb-1">Pilih Program Studi
                                                            </div>
                                                        </div>
                                                        <div class="col-auto">
                            ...
                            <div class="container">
                                <div class="card shadow-lg p-4 mb-5 bg-white rounded">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card-body">
                                                ...
                                                <div class="mt-4 text-center small">
                                                    @php
                                                    // Classify the orangtuaavg
                                                    if ($orangtuaavg >= 3.5324 && $orangtuaavg <= 4) {
                                                        $orangtuaaavggrade='Sangat Baik' ;
                                                        } elseif ($orangtuaavg>= 3.0644 && $orangtuaavg <= 3.532) {
                                                            $orangtuaaavggrade='Baik' ;
                                                            } elseif ($orangtuaavg>= 2.6 && $orangtuaavg <= 3.064) {
                                                                $orangtuaaavggrade='Kurang Baik' ;
                                                                } elseif ($orangtuaavg>= 1.0 && $orangtuaavg <= 2.5996) {
                                                                    $orangtuaaavggrade='Tidak Baik' ;
                                                                    } else {
                                                                    $orangtuaaavggrade='Invalid' ;
                                                                    }
                                                                    @endphp
                                                                    <span class="mr-2">
                                                                    <i class="fas fa-circle text-primary"></i> {{ $orangtuaaavggrade }}
                                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <script>
                                        // Pie Chart for Orang Tua
                                        var ctxOrangtua = document.getElementById("orangtuaPieChart");
                                        var orangtuaPieChart = new Chart(ctxOrangtua, {
                                            type: 'doughnut',
                                            data: {
                                                labels: ["Orang Tua"],
                                                datasets: [{
                                                    data: [JSON.parse('{{ json_encode($orangtuaavg) }}'), JSON.parse(
                                                        '{{ json_encode(4 - $orangtuaavg) }}')],
                                                    backgroundColor: ['#4e73df', '#36b9cc'],
                                                    hoverBackgroundColor: ['#2e59d9', '#2c9faf'],
                                                    hoverBorderColor: "rgba(234, 236, 244, 1)",
                                                }],
