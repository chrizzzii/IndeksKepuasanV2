...
<body>
    ...
    <div class="container-fluid">
        <h1 class="h3 mb-4 text-gray-800">Indeks Dosen</h1>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total
                                            Data Dosen Keseluruhan</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $dosenData }}</div>
                                    </div>
                                    <div class="col-auto">
        ...
        <script>
            ...
            const dataValues = JSON.parse(
                '[{{ $dosenU1 }}, {{ $dosenU2 }}, {{ $dosenU3 }}, {{ $dosenU4 }}, {{ $dosenU5 }}, {{ $dosenU6 }}, {{ $dosenU7 }}, {{ $dosenU8 }}, {{ $dosenU9 }}]'
            );
        ...
        <div class="col-xl-12 col-lg-12 mb-4">
            <div class="card shadow" style="height: 680px; width: 100%; overflow: auto;">
                ...
                <h6 class=" m-0 font-weight-bold
                    text-primary">Distribusi Dosen per Program Studi</h6>
                </div>
                <div class="card-body">
    ...
    <script>
        var prodiLabels = JSON.parse('{!! json_encode(array_keys($jumlahDosenPerProdi)) !!}');
        var prodiData = JSON.parse('{!! json_encode(array_values($jumlahDosenPerProdi)) !!}');
