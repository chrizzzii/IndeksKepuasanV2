...
<body>
    <div class="container-fluid">
        <h1 class="h3 mb-4 text-gray-800">Indeks Orang Tua</h1>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total
                                            Data Orang Tua Keseluruhan</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $orangtuaData }}</div>
                                    </div>
                                    <div class="col-auto">
        ...
        <script>
            ...
            const dataValues = JSON.parse(
                '[{{ $orangtuaU1 }}, {{ $orangtuaU2 }}, {{ $orangtuaU3 }}, {{ $orangtuaU4 }}, {{ $orangtuaU5 }}, {{ $orangtuaU6 }}, {{ $orangtuaU7 }}, {{ $orangtuaU8 }}, {{ $orangtuaU9 }}]'
            );
        ...
        <div class="col-xl-12 col-lg-12 mb-4">
            <div class="card shadow" style="height: 680px; width: 100%; overflow: auto;">
                <div class="card-header py-3" style="color: #FFFFFF" ;>
                    ...
                    text-primary">Distribusi Orang Tua per Program Studi</h6>
                </div>
                <div class="card-body">
    ...
    <script>
        var prodiLabels = JSON.parse('{!! json_encode(array_keys($jumlahOrangtuaPerProdi)) !!}');
        var prodiData = JSON.parse('{!! json_encode(array_values($jumlahOrangtuaPerProdi)) !!}');
