...
<head>
    ...
    <title>Halaman Pendaftaran Pengguna Lulusan</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Pendaftaran Pengguna Lulusan</h1>
                                    </div>
                                    ...
                                    <form method="POST" action="{{ route('register.store.penggunalulusan') }}" class="user">
                                        @csrf
