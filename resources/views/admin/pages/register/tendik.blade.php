...
<head>
    ...
    <title>Halaman Pendaftaran Tendik</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Pendaftaran Tendik</h1>
                                    </div>
                                    ...
                                    <form method="POST" action="{{ route('register.store.tendik') }}" class="user">
                                        @csrf
