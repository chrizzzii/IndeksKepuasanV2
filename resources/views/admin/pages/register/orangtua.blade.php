...
<head>
    ...
    <title>Halaman Pendaftaran Orang Tua</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Pendaftaran Orang Tua</h1>
                                    </div>
                                    <form method="POST" action="{{ route('register.store.orangtua') }}" class="user">
                                        @csrf
