...
class DashboardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $u1total = ($mitraU1 + $alumniU1 + $tendikU1 +$orangtuaU1+ $mahasiswaU1 + $penggunalulusanU1 + $dosenU1) / 7;
        ...
        $orangtuaU2 = Orangtua::where('status', 1)->sum('u2') / $orangtuaData;
        ...
        $u2total = ($mitraU2 + $alumniU2 + $tendikU2 +$orangtuaU2+ $mahasiswaU2 + $penggunalulusanU2 + $dosenU2) / 7;
        ...
        $orangtuaU3 = Orangtua::where('status', 1)->sum('u3') / $orangtuaData;
        ...
        $u3total = ($mitraU3 + $alumniU3 + $tendikU3 +$orangtuaU3+ $mahasiswaU3 + $penggunalulusanU3 + $dosenU3) / 7;
        ...
        $orangtuaU4 = Orangtua::where('status', 1)->sum('u4') / $orangtuaData;
        ...
        $u4total = ($mitraU4 + $alumniU4 + $tendikU4 +$orangtuaU4+ $mahasiswaU4 + $penggunalulusanU4 + $dosenU4) / 7;
        ...
        $orangtuaU5 = Orangtua::where('status', 1)->sum('u5') / $orangtuaData;
        ...
        $u5total = ($mitraU5 + $alumniU5 + $tendikU5 +$orangtuaU5+ $mahasiswaU5 + $penggunalulusanU5 + $dosenU5) / 7;
        ...
        $orangtuaU6 = Orangtua::where('status', 1)->sum('u6') / $orangtuaData;
        ...
        $u6total = ($mitraU6 + $alumniU6 + $tendikU6 +$orangtuaU6+ $mahasiswaU6 + $penggunalulusanU6 + $dosenU6) / 7;
        ...
        $orangtuaU7 = Orangtua::where('status', 1)->sum('u7') / $orangtuaData;
        ...
        $u7total = ($mitraU7 + $alumniU7 + $tendikU7 +$orangtuaU7+ $mahasiswaU7 + $penggunalulusanU7 + $dosenU7) / 7;
        ...
        $orangtuaU8 = Orangtua::where('status', 1)->sum('u8') / $orangtuaData;
        ...
        $u8total = ($mitraU8 + $alumniU8 + $tendikU8 +$orangtuaU8+ $mahasiswaU8 + $penggunalulusanU8 + $dosenU8) / 7;
        ...
        $orangtuaU9 = Orangtua::where('status', 1)->sum('u9') / $orangtuaData;
        ...
        $u9total = ($mitraU9 + $alumniU9 + $tendikU9 +$orangtuaU9+ $mahasiswaU9 + $penggunalulusanU9 + $dosenU9) / 7;
        ...
        // Orangtua mahasiswa average calculation
