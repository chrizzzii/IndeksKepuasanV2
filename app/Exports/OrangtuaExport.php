...
class OrangtuaExport
{
    ...
    public function export()
    {
        ...
        $columns = [
            ...
            'Pertanyaan 10', // Ganti u9 menjadi Pertanyaan 9
            'Pertanyaan 11', // Ganti u9 menjadi Pertanyaan 9
            'Pertanyaan 12', // Ganti u9 menjadi Pertanyaan 9
            'Pertanyaan 13', // Ganti u9 menjadi Pertanyaan 9
            'Pertanyaan 14', // Ganti u9 menjadi Pertanyaan 9
            'Pertanyaan 15', // Ganti u9 menjadi Pertanyaan 9
            'Pertanyaan 16', // Ganti u9 menjadi Pertanyaan 9
            'Pertanyaan 17', // Ganti u9 menjadi Pertanyaan 9
            'Pertanyaan 18', // Ganti u9 menjadi Pertanyaan 9
            'Pertanyaan 19', // Ganti u9 menjadi Pertanyaan 9
            'Pertanyaan 20', // Ganti u9 menjadi Pertanyaan 9
            'Pertanyaan 21', // Ganti u9 menjadi Pertanyaan 9
            'Pertanyaan 22', // Ganti u9 menjadi Pertanyaan 9
            'Pertanyaan 23', // Ganti u9 menjadi Pertanyaan 9
            'Pertanyaan 24', // Ganti u9 menjadi Pertanyaan 9
        ...
        foreach ($tendik as $item) {
            ...
            foreach ($columns as $field) {
                ...
                elseif (strpos($field, 'Pertanyaan') === 0) {
                    ...
                    if (intval($questionNumber) <= 28) {
                        $questionField = 'u' . $questionNumber; // Ambil nilai dari u1 hingga u9
                    } else {
                        $questionField = 'p' . ($questionNumber - 28); // Ambil nilai dari p1 hingga p9
                    }
